...
var $Grvq$exports = {}; // fast apply, http://jsperf.lnkit.com/fast-apply/5
...
var $z3jV$var$NAME = 'name'; // 19.2.4.2 name
...
var $n0sj$var$rConstruct = (($QiI$init(), $QiI$exports).Reflect || {}).construct; // MS Edge supports only 2 arguments and argumentsList argument is optional
